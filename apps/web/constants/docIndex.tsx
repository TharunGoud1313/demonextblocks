import { DocFieldType } from "@/types";

export const docFieldTypes: DocFieldType[] = [
  { name: "Heading", isNew: false },
  { name: "Rich Text Editor", isNew: false },
  { name: "Table", isNew: false },
  { name: "Image", isNew: false },
  { name: "Video", isNew: false },
