      ...
      <div className="md:w-[500px] space-y-3">
        ...
        <div className="flex gap-3">
          ...
          <a
            ...
            target="_blank"
          >
            <Button className=" w-full">View Doc Template</Button>
          </a>
        </div>
      </div>
    </div>
