...
export function ContactsTable({ promises }: ContactsTableProps) {
   ...
   */
  const advancedFilterFields: DataTableAdvancedFilterField<Contact>[] = [
    {
      id: "first_name",
      label: "First name",
      type: "text",
  ...
  const { table } = useDataTable({
    ...
    initialState: {
      sorting: [{ id: "created_datetime", desc: true }],
      columnPinning: { right: ["actions"] },
    },
    getRowId: (originalRow) => originalRow.user_catalog_id?.toString(),
    shallow: false,
    clearOnDefault: true,
  });
