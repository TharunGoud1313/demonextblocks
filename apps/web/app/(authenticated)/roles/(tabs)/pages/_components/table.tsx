...
export function RecordsTable({ promises }: RecordsTableProps) {
  ...
  const [rowAction, setRowAction] =
    React.useState<DataTableRowAction<PageList> | null>(null);
   ...
   */
  const filterFields: DataTableFilterField<PageList>[] = [
    {
      id: "status",
      label: "Status",
      options: pageListStatuses.map((status) => ({
   ...
   */
  const advancedFilterFields: DataTableAdvancedFilterField<PageList>[] = [
    {
      id: "status",
      label: "Status",
      type: "multi-select",
  ...
  const { table } = useDataTable({
    ...
    getRowId: (originalRow) => originalRow.pagelist_id?.toString(),
    shallow: false,
    clearOnDefault: true,
  });
            ...
            endContent={
              <>
                ...
                <Button
                  ...
                  onClick={() =>
                    setRowAction({ row: {} as Row<PageList>, type: "new" })
                  }
                >
