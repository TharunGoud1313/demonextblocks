...
import PieChart from "@/components/AgentMaker/field-components/ChartTypes/PieChart";
import BarChart from "@/components/AgentMaker/field-components/ChartTypes/BarChart";
import LineGraph from "@/components/AgentMaker/field-components/ChartTypes/LineGraph";
import HorizontalBarChart from "@/components/AgentMaker/field-components/ChartTypes/BarChartHorizontal";
...
import NarrativeTemplate from "@/components/AgentMaker/field-components/NarrativeTemplate";
import PugStoryTemplate from "@/components/AgentMaker/chat-with-data-auto/PugStoryTemplate";
import GanttChart from "@/components/AgentMaker/chat-with-data-auto/GanttChart";
import AnalyticJSON from "@/components/AgentMaker/chat-with-data-json/AnalyticJSON";
    ...
    <div>
      <Card className="p-2.5 overflow-x-auto  md:w-[760px]">
        <Tabs className="w-full" defaultValue="data">
          <TabsList defaultValue={"data"} className="grid grid-cols-9 gap-2.5">
          ...
          <TabsContent value="pug-story">
            <PugStoryTemplate data={data} componentName={componentName} />
          </TabsContent>
