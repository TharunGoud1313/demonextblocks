...
export const Results = ({
  ...
  console.log("results----", { results, columns, chartConfig });
  ...
  return (
    <div className="flex-grow max-w-[800px] overflow-x-auto flex flex-col">
      <Tabs defaultValue="table" className="w-full flex-grow flex flex-col">
        ...
        <TabsContent value="table" className="flex-grow">
          <div className="sm:min-h-[10px] relative">
            <Table className="min-w-full max-w-[800px] overflow-x-auto divide-y divide-border">
              ...
              <TableBody className="bg-card divide-y divide-border">
                {results.map((company: any, index: any) => (
